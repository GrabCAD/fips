...
macro(fips_add_generator target in_generator in_outofsource in_file out_src out_hdr args)
    if (FipsAddFilesEnabled)
        ...
        get_filename_component(f_src ${out_src} NAME)
        get_filename_component(f_hdr ${out_hdr} NAME)
        ...
        if ("${out_src}" STREQUAL "")
            ...
            if (${in_outofsource}) 
                set(out_src_abs "${CMAKE_CURRENT_BINARY_DIR}/${f_src}")
            else()
                set(out_src_abs "${f_dir}/${f_src}")
            endif()
        ...
        if ("${out_hdr}" STREQUAL "")
            ...
            if (${in_outofsource})
                set(out_hdr_abs "${CMAKE_CURRENT_BINARY_DIR}/${f_hdr}")
            else()
                set(out_hdr_abs "${f_dir}/${f_hdr}")
            endif()
